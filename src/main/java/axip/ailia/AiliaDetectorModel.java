...
public class AiliaDetectorModel implements AutoCloseable {
	 ...
	 *
	 * @see AiliaDetector#Destroy(long)
	 */
    public void close() {
	 ...
	 * @throws AiliaException Exception
	 * @see AiliaDetector#Compute(long, byte[], int, int, int, int, float, float)
	 */
	 ...
	 * @throws AiliaException Exception
	 * @see AiliaDetector#GetObjectCount(long)
	 */
	 ...
	 * @throws AiliaException Exception
	 * @see AiliaDetector#GetObject(long, int, int)
	 */
	 ...
	 * @throws AiliaException Exception
	 * @see AiliaDetector#SetAnchors(long, float[], int)
	 */
